 ...
 * @since：2013-9-23
 */
public class ChooseCityActivity extends BasicActivity {
	...
	private void initListener() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				   ...
				   if(regionType==1)
				   {
					Intent it1 = new Intent(ChooseCityActivity.this,ChooseNextCityActivity.class);
					it1.putExtra(City.ID, mListItem.get(position).getId());
