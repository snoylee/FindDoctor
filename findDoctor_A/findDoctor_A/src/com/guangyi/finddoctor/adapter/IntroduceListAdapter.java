...
public class IntroduceListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tv_desc.setText(mList.get(position).getDesc());
		ImageManager2.from(mContext).displayImage(viewHolder.imageView, mList.get(position).getLogoUrl(), R.drawable.icon);
