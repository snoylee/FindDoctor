...
public class SearchDiseaseAdapter extends BaseAdapter{
	...
	public  SearchDiseaseAdapter(Context context,List<Disease> list)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tv_search_diseaseintroduce.setText(Html.fromHtml(mList.get(position).getDescript()+""));
		return convertView;
	}
