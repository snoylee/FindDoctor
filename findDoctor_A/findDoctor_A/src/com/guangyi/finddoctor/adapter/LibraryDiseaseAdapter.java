...
public class LibraryDiseaseAdapter extends  BaseAdapter implements SectionIndexer {
	private List<Disease> list = null;
	private Context mContext;
	
	public LibraryDiseaseAdapter(Context mContext,List<Disease> list) {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final Disease mContent = list.get(position);
		if (view == null) {
