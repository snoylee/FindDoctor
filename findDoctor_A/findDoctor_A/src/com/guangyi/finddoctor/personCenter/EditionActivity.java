...
public class EditionActivity extends BasicActivity {
	...
	private void initView() {
		...
		String versionName="";
		try {
			versionName = getPackageManager().getPackageInfo(UpdateManager.packageName, 0).versionName;
		...
		String lastVersionName="";
		 try {
			 currentVersion=getPackageManager().getPackageInfo(UpdateManager.packageName, 0).versionCode;
