...
import com.guangyi.forDoctor.adapter.OnLineMainListAdapterReply;
import com.guangyi.forDoctor.adapter.OnlineMainListAdapterNotReply;
...
public class OnLineMainActivity extends BasicActivity {
	...
	private int data1=0,data2=1,data3=3;
	private List<DoctorConsult> list1, list2, list3;
	private OnlineMainListAdapterNotReply adapter1, adapter3;
	private OnLineMainListAdapterReply adapter2;
...
//		adapter3.notifyDataSetChanged();
		...
		PageNo1=1;
		list1.clear();
		getData(1, PageNo1, pageSize, data1);
		
		
//		getData(2, PageNo2, pageSize, data2);
//		getData(3, PageNo3, pageSize, data3);
	}
...
//		getData(3, PageNo3, pageSize, data3);
					...
					try {
						...
						if (jsonObject.getInt("code") == 0) {
							JSONArray jsonArray = jsonObject
									.getJSONArray("doctorConsultingList");
							...
							case 1:
								...
								for (int m = 0; m < jsonArray.length(); m++) {
									...
									doctorConsult.setConsReplyTitle(jsonArray
											.getJSONObject(m).getString(

											DoctorConsult.CONSREPLYTITLE));
									doctorConsult.setConsTime(jsonArray
											.getJSONObject(m).getString(
													DoctorConsult.CONSTIME));
									doctorConsult.setConsTitle(jsonArray
											.getJSONObject(m).getString(
													DoctorConsult.CONSTITLE));
									doctorConsult.setScore(jsonArray
											.getJSONObject(m).getString(
													DoctorConsult.SCORE));
									doctorConsult.setConsId(jsonArray
											.getJSONObject(m).getInt(
													DoctorConsult.CONSID));
									doctorConsult.setConsState(jsonArray
											.getJSONObject(m).getInt(
													DoctorConsult.CONSSTATE));
									list1.add(doctorConsult);
								...
								View emptyView = LayoutInflater.from(OnLineMainActivity.this).inflate(R.layout.empty_view, null);
							...
							case 2:
								...
								View emptyView2 = LayoutInflater.from(OnLineMainActivity.this).inflate(R.layout.empty_view, null);
							...
							case 3:
								...
								View emptyView3 = LayoutInflater.from(OnLineMainActivity.this).inflate(R.layout.empty_view, null);
	...
	private void initView1(View view) {
		...
		adapter1 = new OnlineMainListAdapterNotReply(this, list1);
		...
		listView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				it.putExtra("type", 1);
				it.putExtra("consId", list1.get(arg2).getConsId() + "");
				it.setClass(OnLineMainActivity.this, OnlineChatActivity.class);
				startActivity(it);
	...
	private void initView2(View view) {
		...
		adapter2 = new OnLineMainListAdapterReply(this, list2);
		...
		listView2.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent it = new Intent();
				it.putExtra("type", 2);
				it.putExtra("consState", list2.get(arg2).getConsState());
				it.putExtra("consId", list2.get(arg2).getConsId() + "");
				it.setClass(OnLineMainActivity.this, OnlineChatActivity.class);
				startActivity(it);
	...
	private void initView3(View view) {
		...
		adapter3 = new OnlineMainListAdapterNotReply(this, list3);
		...
		listView3.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent it = new Intent();
				it.putExtra("type", 3);
				it.putExtra("consId", list3.get(arg2).getConsId() + "");
				it.setClass(OnLineMainActivity.this, OnlineChatActivity.class);
				startActivity(it);
		...
		mRunnable=new Runnable() {
			...
			public void run() {
				...
				msg.obj = mApiHttpUtil.postMethod(
						Config.getProperty("GET_DOC_CONSLIST_BYEXPERTID", ""),
						params);
