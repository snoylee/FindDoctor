...
import com.guangyi.forDoctor.adapter.HospitalRegisterListAdapter;
...
public class HospitalRegisterActivity extends BasicActivity implements
	...
	private HospitalRegisterListAdapter adapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hospital_register_main);
	...
	private void initParams() {
		...
		adapter = new HospitalRegisterListAdapter(this, list);
					...
					try {
						...
						if (jsonObject.getInt("code") == 0) {
							...
							for (int i = 0; i < jsonArray.length(); i++) {
								...
								//
								phoneAskItem.setAppoState(jsonArray
										.getJSONObject(i).getInt(
												PhoneOrHospital.APPOSTATE));
							...
							else
							{
								...
								View emptyView = LayoutInflater.from(HospitalRegisterActivity.this).inflate(R.layout.empty_view, null);
								...
								View emptyView2 = LayoutInflater.from(HospitalRegisterActivity.this).inflate(R.layout.empty_view, null);
	...
	private void initView1(View view) {
		...
		listView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				 ...
				 it.setClass(HospitalRegisterActivity.this,
						 HospitalRegisterDetail.class);
				 startActivity(it);
